...
import { MessageSquare, LayoutDashboard, BarChart2, LineChart, Users, Wallet, DollarSign, FileText, Ban, Settings, LogOut, ArrowLeft, Menu, X } from "lucide-react";
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-3 bg-sidebar border-b border-sidebar-border">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-sm text-sidebar-foreground">Admin Panel</span>
        </div>
